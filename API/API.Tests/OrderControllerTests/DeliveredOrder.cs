...
namespace API.Tests.OrderControllerTests
{
    ...
    public class DeliveredOrder : OrderControllerDependencyProvider
    {
        [Fact]
        public async void DeliveredOrderReturn200()
        {
            ...
            var actionResult = await _orderController.DeliveredOrder(order.Id);
        ...
        [Fact]
        public async void DeliveredOrderReturn404()
        {
            AppUser user = new() { Id = 1 };
        ...
        [Fact]
        public async void DeliveredOrderReturn400_1()
        {
            AppUser user = new() { Id = 1 };
            Order order = new() 
            { 
        ...
        [Fact]
        public async void DeliveredOrderReturn400_2()
        {
            AppUser user = new() { Id = 1 };
            Order order = new() 
            { 
